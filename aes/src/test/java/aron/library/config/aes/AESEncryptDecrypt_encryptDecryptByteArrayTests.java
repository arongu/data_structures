...
public class AESEncryptDecrypt_encryptDecryptByteArrayTests {
    ...
    public void encryptByteArrayWithKeyTest()
    throws AESToolException {
        final SecretKey secretKey = AESEncryptDecrypt.derive256BitAESKeyWithHmacSHA256("password", "abcdef0123456789", 500_000);
        final String    text      = "this is my super-secret text with ~!@#$%^&*()_+ all sort of characters";

        byte[] data      = text.getBytes(StandardCharsets.UTF_8);
        byte[] encrypted = AESEncryptDecrypt.encryptByteArrayWithKey(secretKey, data);
        byte[] decrypted = AESEncryptDecrypt.decryptCipherArrayWithKey(secretKey, encrypted);
    ...
    public void encryptByteArraysWithKeyTest()
    throws AESToolException {
    ...
    public void encryptDecryptStringWithBase64KeyTest()
    throws IOException, AESToolException {
